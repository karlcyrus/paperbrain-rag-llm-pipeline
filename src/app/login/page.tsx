    ...
    <div className="min-h-screen bg-zinc-950 selection:bg-zinc-800 relative overflow-hidden flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-zinc-400 font-light">Sign in to your account</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-zinc-500">
          ...
          <Link href="/signup" className="text-zinc-300 font-medium hover:text-white transition-colors">
            Sign up
          </Link>
        </p>
      </div>
